...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/sandalu-thisanka-719564334/",
    color: "#0A66C2",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@SandaluThisanka",
    icon: Github,
    url: "https://github.com/SandaluThisanka",
    color: "#ffffff",
  ...
  },
  {
    ...
    subText: "@sandalu_thisanka",
    icon: Facebook,
    url: "https://www.facebook.com/share/17eo9Czspd/",
    color: "#1877F2",
  ...
  return (
    <div className="w-full p-6 py-8 bg-gradient-to-br from-white/10 to-white/5 rounded-2xl backdrop-blur-xl">
      <h3 className="flex items-center gap-2 mb-6 text-xl font-semibold text-white">
        <span className="inline-block w-8 h-1 bg-gradient-to-r from-[#f6c500] to-[#38bdf8] rounded-full"></span>
        Connect With Me
      </h3>
...
>
  ...
  {/* External Link */}
  <ExternalLink 
    className="relative w-5 h-5 text-gray-500 transition-all duration-300 transform -translate-x-1 opacity-0 group-hover:text-white group-hover:opacity-100 group-hover:translate-x-0"
  />

  {/* Shine Effect */}
  <div 
    className="absolute inset-0 overflow-hidden opacity-0 pointer-events-none group-hover:opacity-100"
  >
